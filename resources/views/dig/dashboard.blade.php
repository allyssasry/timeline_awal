    ...
    @if ($projects->isNotEmpty())
      <div class="mt-8 space-y-8">
        @foreach ($projects as $project)
          @php
            // Cincin progres: ambil update terbaru masing2 progress, lalu rata-ratakan
            $latestPercents = [];
            foreach ($project->progresses as $pr) {
              // pada controller, updates disarankan sudah latest(); kalau belum, pakai sortByDesc sebagai fallback
            ...
            // Pakai accessor model agar status persisten
            ...
            // Boleh putuskan? (memakai accessor can_decide_completion dari model)
